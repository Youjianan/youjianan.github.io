...
function bot_ui_ini() {
    ...
    var sure = function () {
            ...
            botui.message.add({
                delay: 1500,
                content: "![...](https://cdn.jsdelivr.net/gh/Youjianan/cdn@1.41/img/meme/BadEnd.jpg)"
            })
        },
        secondpart = function () {
            botui.message.add({
        ...
        fifthpart = function () {
            botui.message.add({
                delay: 1200,
                content: "我不是，我没有，二次元迷是什么，你别乱说啊！（手动狗头）"
            }).then(function () {
                botui.message.add({
                    delay: 1200,
                    content: "我就只是喜欢看看动画、追追漫画、听听日语歌，如此而已啊"
                }).then(function () {
                    botui.message.add({
                        delay: 1200,
                        content: "那么请愉快的阅读我的博客吧 (=・ω・=)"
                    }).then(function () {
                        botui.message.add({
                            delay: 1500,
                            content: "![...](https://cdn.jsdelivr.net/gh/Youjianan/cdn@1.41/img/meme/TrueEnd.jpg)"
                        })
                    })
                })
            })
